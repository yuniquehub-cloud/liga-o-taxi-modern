  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-50 grid grid-cols-2 border-t border-border bg-background/95 backdrop-blur md:hidden">
      <a
        ...
        className="flex min-h-14 items-center justify-center gap-2 text-sm font-extrabold text-foreground"
      >
      ...
      <a
        ...
        className="flex min-h-14 items-center justify-center gap-2 bg-yellow text-sm font-extrabold text-yellow-foreground"
      >
